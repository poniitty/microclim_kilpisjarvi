...
df <- df %>% 
  filter((siteid == "L4" & datetime >= as.Date("2022-07-14", tz = "Etc/GMT-2"))) %>% 
  filter((siteid == "L14" & datetime >= as.Date("2022-07-19", tz = "Etc/GMT-2"))) %>% 
  filter((siteid == "L15" & tomst_id == 94213516 & datetime >= as.Date("2022-07-20", tz = "Etc/GMT-2")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-15")))
probls <- c()
hattu <- c(as_date(as_date("2022-04-18"):as_date("2022-09-17")))
...
siteid <- "AIL103"
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-15")))
probls <- c(as_date(as_date("2022-05-30"):as_date("2022-09-17")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-15")))
probls <- c(as_date(as_date("2021−11−14"):as_date("2022-09-17")))
hattu <- c()
...
hattu <- c(as_date(as_date("2022-06-25"):as_date("2022-09-17")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-17")))
probls <- c()
hattu <- c(as_date(as_date("2022-07-04"):as_date("2022-09-17")))
...
hattu <- c(as_date(as_date("2022-05-23"):as_date("2022-09-27")))
...
probls <- c()
hattu <- c()
T1moisterror <- c(as_date(as_date("2022-06-20"):as_date("2022-09-18")))
...
hattu <- c(as_date(as_date("2020-07-05"):as_date("2020-08-12")),
           as_date(as_date("2022-08-30"):as_date("2022-09-27")))
...
hattu <- c(as_date(as_date("2021-06-06"):as_date("2021-08-26")),
           as_date(as_date("2022-06-20"):as_date("2022-09-17")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-27")))
probls <- c()
hattu <- c(as_date(as_date("2022-06-26"):as_date("2022-09-27")))
...
probls <- c()
hattu <- c(as_date(as_date("2022-05-06"):as_date("2022-09-27")))
...
########################################################################
# Julia's spring sites

# SITE = L1
siteid <- "L1"

office <- c(as_date(as_date(min(df$datetime)):as_date("2021-07-29")))
probls <- c()
hattu <- c()
T2T3error <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2021-07-30")))
probls <- c()
hattu <- c()
T1moisterror <- c(as_date(as_date("2022-01-23"):as_date("2021-07-30")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2021-07-09")))
probls <- c(as_date(as_date("2021-07-10"):as_date("2021-07-30")))
hattu <- c()
T2T3error <- c(as_date(as_date("2021-07-31"):as_date("2022-09-20")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2021-07-02")))
probls <- c(as_date(as_date("2021-07-03"):as_date("2021-07-30")))
hattu <- c()
T2T3error <- c(as_date(as_date("2021-07-31"):as_date("2022-09-20")))
...
probls <- c()
hattu <- c()
T2T3error <- c(as_date(as_date("2022-06-18"):as_date("2022-07-20")))

df2 %>% mutate(probl = ifelse(site == siteid & tomst_id == tomst &
                                date %in% office,
                              2, probl)) %>% 
  mutate(probl = ifelse(site == siteid & tomst_id == tomst &
                          date %in% probls,
                        1, probl)) %>% 
  mutate(probl = ifelse(site == siteid & tomst_id == tomst &
                          date %in% hattu,
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2021-07-15")),
            as_date(as_date("2021-09-30"):as_date("2021-07-15")))
probls <- c(as_date(as_date("2021-07-16"):as_date("2022-08-20")))
hattu <- c()
T2T3error <- c()
...
hattu <- c(as_date(as_date("2022-08-17"):as_date("2022-09-25")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-23")))
probls <- c()
hattu <- c(as_date(as_date("2022-08-22"):as_date("2022-09-25")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-23")))
probls <- c()
hattu <- c(as_date(as_date("2022-07-31"):as_date("2022-09-25")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-07")))
probls <- c()
hattu <- c(as_date(as_date("2022-06-04"):as_date("2022-08-19")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-08")))
probls <- c()
hattu <- c(as_date(as_date("2022-06-04"):as_date("2022-09-26")))
...
probls <- c()
hattu <- c()
moisterror <- c(as_date(as_date("2021-08-15"):as_date("2022-08-19")))
...
hattu <- c(as_date(as_date("2021-07-16"):as_date("2021-08-20")),
           as_date(as_date("2022-08-01"):as_date("2022-09-22")))
...
hattu <- c(as_date(as_date("2022-06-25"):as_date("2021-08-19")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-08")),
            as_date(as_date("2021-08-28"):as_date("2021-08-31")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-06")))
probls <- c()
hattu <- c(as_date(as_date("2022-07-20"):as_date("2022-09-22")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-09")))
probls <- c(as_date(as_date("2021-08-30"):as_date("2022-08-19")))
hattu <- c()
...
probls <- c()
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-20"):as_date("2021-08-30")))
...
probls <- c()
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-21"):as_date("2021-08-30")))
...
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-25"):as_date("2021-08-04")))
...
probls <- c()
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-25"):as_date("2021-08-10")))
...
probls <- c()
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-26"):as_date("2021-08-08")))
...
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-28"):as_date("2021-05-30")))
...
probls <- c()
hattu <- c()
moisterror <- c(as_date(as_date("2020-08-07"):as_date("2021-08-15")))
...
probls <- c()
hattu <- c()
moisterror <- c(as_date(as_date("2020-08-05"):as_date("2021-08-15")))
...
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-30"):as_date("2020-09-16")),
                as_date(as_date("2021-07-28"):as_date("2021-08-10")))
...
probls <- c()
hattu <- c()
moisterror <- c(as_date(as_date("2020-08-06"):as_date("2021-08-24")))
...
probls <- c(as_date(as_date("2021-08-22"):as_date("2021-08-28")),
            as_date(as_date("2022-07-28"):as_date("2022-08-19")))
hattu <- c()
moisterror <- c(as_date(as_date("2020-08-06"):as_date("2021-08-21")))
...
probls <- c()
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-23"):as_date("2021-08-12")))
...
probls <- c()
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-23"):as_date("2021-08-14")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2020-07-22")))
probls <- c()
hattu <- c(as_date(as_date("2022-07-18"):as_date("2022-08-14")))
moisterror <- c(as_date(as_date("2020-07-23"):as_date("2021-08-13")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2020-07-22")))
probls <- c()
hattu <- c(as_date(as_date("2022-07-28"):as_date("2022-08-13")))
moisterror <- c(as_date(as_date("2020-07-23"):as_date("2021-08-14")))
...
probls <- c()
hattu <- c(as_date(as_date("2022-04-12"):as_date("2022-08-09")))
moisterror <- c(as_date(as_date("2020-07-24"):as_date("2021-08-15")))
...
probls <- c()
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-24"):as_date("2021-08-11")))
...
probls <- c()
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-25"):as_date("2021-08-30")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2020-07-24")))
probls <- c()
hattu <- c(as_date(as_date("2022-07-20"):as_date("2022-08-01")))
moisterror <- c(as_date(as_date("2020-07-25"):as_date("2021-08-10")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2020-07-24")))
probls <- c()
hattu <- c(as_date(as_date("2022-07-22"):as_date("2022-08-01")))
moisterror <- c(as_date(as_date("2020-07-25"):as_date("2021-08-10")))
...
probls <- c()
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-25"):as_date("2021-07-23")))
...
probls <- c()
hattu <- c()
T1moisterror <- c(as_date(as_date("2021-06-11"):as_date("2021-07-23")))
moisterror <- c(as_date(as_date("2020-07-25"):as_date("2021-06-10")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2020-07-25")))
probls <- c(as_date(as_date("2021-08-11"):as_date("2022-08-02")))
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-26"):as_date("2021-08-08")))
...
probls <- c()
hattu <- c(as_date(as_date("2022-07-22"):as_date("2022-08-10")))
moisterror <- c(as_date(as_date("2020-07-27"):as_date("2021-08-15")))
...
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-27"):as_date("2021-08-15")))
T1moisterror <- c(as_date(as_date("2022-05-10"):as_date("2022-08-15")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2020-07-27")))
probls <- c(as_date(as_date("2022-07-13"):as_date("2022-08-01")))
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-28"):as_date("2021-08-24")))
T1moisterror <- c(as_date(as_date("2022-06-12"):as_date("2022-08-15")))
...
probls <- c(as_date(as_date("2022-05-23"):as_date("2022-08-16")))
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-29"):as_date("2021-08-30")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2020-07-28")))
probls <- c(as_date(as_date("2021-07-30"):as_date("2021-08-02")))
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-29"):as_date("2021-03-25")))
T1moisterror <- c(as_date(as_date("2021-03-26"):as_date("2021-07-29")))
...
probls <- c()
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-30"):as_date("2021-08-10")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2020-07-29")))
probls <- c(as_date(as_date("2020-11-13"):as_date("2021-08-02")))
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-30"):as_date("2021-08-30")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2020-08-04")))
probls <- c()
hattu <- c(as_date(as_date("2022-07-18"):as_date("2022-08-12")))
moisterror <- c(as_date(as_date("2020-08-05"):as_date("2021-08-13")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2020-08-04")))
probls <- c(as_date(as_date("2022-08-08"):as_date("2021-08-16")))
hattu <- c()
moisterror <- c(as_date(as_date("2020-08-05"):as_date("2021-08-15")))
...
probls <- c()
hattu <- c()
moisterror <- c(as_date(as_date("2020-08-15"):as_date("2021-08-15")))
...
probls <- c()
hattu <- c()
moisterror <- c(as_date(as_date("2018-06-24"):as_date("2022-09-18")))
...
probls <- c()
hattu <- c()
moisterror <- c(as_date(as_date("2020-07-25"):as_date("2021-07-25")))
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2021-09-28")))
probls <- c()
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2018-06-18")))
probls <- c(as_date(as_date("2022-08-10"):as_date("2022-09-19")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2018-06-19")))
probls <- c(as_date(as_date("2020-07-20"):as_date("2020-08-30")))
...
hattu <- c(as_date(as_date("2019-05-18"):as_date("2019-06-13")),
           as_date(as_date("2022-08-24"):as_date("2022-09-20")))
